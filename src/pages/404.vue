<template>
   <section class="flex items-center h-full p-16 text-black dark:bg-gray-900 dark:text-gray-100">
      <div class="container flex flex-col items-center justify-center px-5 mx-auto my-8">
         <div class="max-w-md text-center">
            <h2 class="mb-8 font-extrabold  dark:text-gray-600 font-black" style="font-size: 6.875rem;">
